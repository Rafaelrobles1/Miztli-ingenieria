...
--Direccion de los cuartos agregados
INSERT INTO "Direccion_c"
...
(fecha_inicio, fecha_fin, id_cuarto, id_evaluacion)
VALUES 
('2016/01/15', '2016/03/15', 1, 1),
('2015/12/01', '2015/01/01', 2, 2),
('2015/12/25', '2016/03/25', 3, 3);
--Evaluacion
INSERT INTO "Evaluacion"
(cumplimiento_contrato, calificacion, observaciones_e, recomentar, id_usuario)
VALUES
('T', 1,'El propietario es un ogro', 'F', 1),
('F', 5,'Sin comentarios negativos', 'T', 1),
('T', 4,'Excelentes servicios', 'T', 1)
--Relaciones
INSERT INTO "tiene_contrato_u"
(contrato, estudiante, prestador)
VALUES (1,1,6),(2,2,7),(3,3,8);

INSERT INTO "tiene_cuarto_p"
(cuarto, prestador)
