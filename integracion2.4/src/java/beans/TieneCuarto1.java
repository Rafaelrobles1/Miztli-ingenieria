...
public class TieneCuarto1 implements Serializable {
    ...
    public TieneCuarto1(Integer cuarto) {
        this.cuarto = cuarto;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TieneCuarto1)) {
            return false;
        }
        TieneCuarto1 other = (TieneCuarto1) object;
