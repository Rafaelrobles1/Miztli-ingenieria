...
CREATE TABLE "tiene_direccion_c"(
  ...
  CONSTRAINT tiene_direccion_c_direccion_u_fkey FOREIGN KEY (direccion_c)
      REFERENCES "direccion_cuarto" (id_direccion_c) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);  
...
CREATE TABLE "tiene_direccion_u"(
  ...
  CONSTRAINT tiene_direccion_u_direccion_fkey FOREIGN KEY (direccion)
      REFERENCES direccion_usuario (id_direccion_u) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
